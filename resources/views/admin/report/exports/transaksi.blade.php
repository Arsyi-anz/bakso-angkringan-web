{{-- resources/views/admin/report/exports/transaksi.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="utf-8">
    ...
    <style>
        * { font-family: DejaVu Sans, sans-serif; }
        ...
        .total { background: #f3f4f6; padding: 8px 10px; border-radius: 4px; margin-bottom: 10px; font-weight: bold; }
        ...
        <tbody>
            @forelse ($laporan as $l)
                <tr>
                    ...
                    <td class="right">Rp {{ number_format($l['total_transaksi'], 0, ',', '.') }}</td>
                </tr>
            @empty
